...
WHERE
    ...
    -- تحديد الفترة الزمنية التي تريد حصرها بين التواريخ
    AND W.ScheduledStartDate > '2011-01-01'  -- استبدل بالتاريخ المناسب
    AND W.ActualEndDate < '2014-12-31';      -- استبدل بالتاريخ المناسب
